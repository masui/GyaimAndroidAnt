    ...
    */
    ...
    public void onUpdateCursorAnchorInfo(CursorAnchorInfo cursorAnchorInfo){
        ...
        */
        ...
        float f[] = new float[9];
        matrix.getValues(f);
        Message.message("Gyaim","matrix = "+f[0]);
        Message.message("Gyaim","matrix = "+f[1]);
        Message.message("Gyaim","matrix = "+f[2]);
        Message.message("Gyaim","matrix = "+f[3]);
        Message.message("Gyaim","matrix = "+f[4]);
        Message.message("Gyaim","matrix = "+f[5]);
        Message.message("Gyaim","matrix = "+f[6]);
        Message.message("Gyaim","matrix = "+f[7]);
        Message.message("Gyaim","matrix = "+f[8]);
        
        int loc[] = new int[2];
        candView.getLocationInWindow(loc);
        Message.message("Gyaim","location x= "+loc[0]);
        Message.message("Gyaim","location y= "+loc[1]);
        ...
        Message.message("Gyaim","flocation x= "+floc[0]);
        Message.message("Gyaim","flocation y= "+floc[1]);
